...
public class next_allselectedcitizen extends AppCompatActivity {
    TextView tvuser;
    Button btngeninfo;
    Button btneduinfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_allselectedcitizen);
        ...
        btngeninfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(next_allselectedcitizen.this,citizen_general_info.class);
        ...
        btneduinfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(next_allselectedcitizen.this,citizen_edu_info.class);
                intent1.putExtras(bundle);
                startActivity(intent1);
            }
        });
        ...
        btnhealthinfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(next_allselectedcitizen.this,citizen_health_info.class);
                intent1.putExtras(bundle);
                startActivity(intent1);
            }
        });
