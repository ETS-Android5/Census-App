...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fab =(ExtendedFloatingActionButton) findViewById(R.id.fab_seach);
    fab.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        if (detected && goon){
          //Toast.makeText(DetectorActivity.this, "detected is true and goon is true", Toast.LENGTH_SHORT).show();
          Intent intent = new Intent(DetectorActivity.this, General_Information_Form1.class);
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    try {
      ...
      detector =
              com.example.jpro.TFLiteObjectDetectionAPIModel.create(
                      getAssets(),
