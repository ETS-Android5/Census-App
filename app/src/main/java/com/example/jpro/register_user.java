    ...
    private class SendMail extends AsyncTask<Message,String,String>{
        ...
        protected String doInBackground(Message... messages) {
            try {
                ...
                e.printStackTrace();
                //Log.d(TAG, "doInBackground: "+e.printStackTrace());
                return "Fail";
            }
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("Success")){
                Toast.makeText(register_user.this, "Email Sent",
                        Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(register_user.this, "Email sending failed.",
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
...
//        pdialog.setContentView(R.layout.alert_dialog);
//        alertBt = (Button)pdialog.findViewById(R.id.bgalert);
//        tvalert = (TextView)pdialog.findViewById(R.id.dialogtv);
//        tvalert.setText("New User Created Successfully!\n\n New User's login credentials has been sent via Email.");
