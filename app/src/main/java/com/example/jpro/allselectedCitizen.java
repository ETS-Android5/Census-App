...
public class allselectedCitizen extends AppCompatActivity implements citizen_adapter.selectedCitizen {
    TextView tvname;
    String refnum="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allselected_citizen);
    ...
    public void selectedcitizen(CitizenDataClass citizenDataClass) {
        startActivity(new Intent(allselectedCitizen.this, next_allselectedcitizen.class).putExtra("data",citizenDataClass));
    }
}