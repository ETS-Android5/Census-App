...
public class supervisors_list extends AppCompatActivity implements Users_adapter.SelectedUser{
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)findViewById(R.id.recyclerviewsuper);
...
//                recyclerView.setAdapter(users_adapter);
    ...
    public void selectedUser(User user) {
        startActivity(new Intent(supervisors_list.this,Selected_user.class).putExtra("data",user));
    }
